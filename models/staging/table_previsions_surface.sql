...
WHERE h.mode_transport IN ('bus', 'tram')
GROUP BY h.date_jour, h.annee, h.mois, h.jour_semaine, h.id_ligne, h.mode_transport, h.precipitation, h.vent, h.neige, h.temperature, h.meteo_defavorable,
